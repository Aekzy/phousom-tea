            ...
            <div className="bg-card border border-border rounded-lg p-6 space-y-6 sticky top-24">
                    ...
                    <button
                      ...
                      className={`block w-full text-left px-3 py-2 rounded-lg transition-colors text-sm ${
                        selectedCategory === category
                          ...
                          : 'text-card-foreground hover:bg-accent/5'
                      }`}
                    >
                      {category}
                    </button>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-card border border-border rounded-lg px-3 py-2 text-sm text-card-foreground"
                >
                    ...
                    <div className="p-6 space-y-3">
                      ...
                      <div className="flex items-center justify-between pt-4">
                        ...
                        <Link
                          ...
                          className="bg-primary text-primary-foreground px-4 py-2 rounded-lg hover:bg-secondary transition text-sm font-semibold flex items-center gap-2"
                        >
